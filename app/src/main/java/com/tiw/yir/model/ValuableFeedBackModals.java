...
public class ValuableFeedBackModals {
    ...
    public ValuableFeedBackModals(int image, int img_like, int img_comment, int img_share, String name, String headlines, String news) {
        this.image = image;
