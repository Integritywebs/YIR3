...
public class MonthlyScholarshipFragment extends Fragment {


    RecyclerView monthlyScholarship_rv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_monthly_scholarship, container, false);
        monthlyScholarship_rv = view.findViewById(R.id.monthly_scholarship_rv);
